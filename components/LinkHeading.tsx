...
export default function LinkHeading(props: LinkHeadingProps) {
    return (
        <div className="relative">
            ...
            <a
                className={cn('group flex gap-2 items-center text-inherit hover:underline decoration-1 underline-offset-4 decoration-secondary decoration-dotted', props.className)}
                href={`#${props.id}`}
            >
